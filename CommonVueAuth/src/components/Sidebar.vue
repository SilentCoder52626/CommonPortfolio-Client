    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <div class="flex items-center justify-center mt-3">
        <div class="flex items-center">
          ...
          <router-link to="/" class="mx-2 text-2xl font-semibold text-white">CW-FOLIO</router-link>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link  class="flex items-center px-6 py-2 mt-1 duration-200 border-l-4"
          :class="[$route.name === 'highlights' ? activeClass : inactiveClass]" to="/highlights" :onClick="hideSidebar">
          <fa icon="bolt"/>
          <span class="mx-4">Highlights</span>
        </router-link>
        ...
        <router-link  class="flex items-center px-6 py-2 mt-1 duration-200 border-l-4"
          :class="[$route.name === 'educations' ? activeClass : inactiveClass]" to="/educations" :onClick="hideSidebar">
